...
export default function AdsCustomizationModal({
  isOpen,
  toggle,
  selectedColumns,
  setSelectedColumns,
  ...
  useEffect(() => {
    ...
    setLocalColumns((prev) => (columnsSignature(prev) === columnsSignature(nextColumns) ? prev : nextColumns));
    setSearchQuery("");
      ...
      <div className="ccm-modal" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="ccm-body">
          <div className="ccm-column">
            ...
            <div className="ccm-list-container" onDragOver={handleDragOver} onDrop={handleDropOnHidden}>
