...
const API_BASE = "https://api.adaxxpro.com/api";
...
export const updateScheduleReportStatus = (scheduleId, status) => {
  return axios.put(`${API_BASE}/schedulereport/status/${scheduleId}`, { status });
};
...
export const getallaccountmanagers = () => {
  return axios.get(`${API_BASE}/accountmanagers`);
};
