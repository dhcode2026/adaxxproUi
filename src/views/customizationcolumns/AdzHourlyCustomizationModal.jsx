...
const ADZ_HOURLY_COLUMN_GROUPS = {
  Basic: [
    "Name",
    "Status",
    "ID",
...
const ADZ_HOURLY_AVAILABLE_COLUMNS = Object.values(ADZ_HOURLY_COLUMN_GROUPS).flat();

const AdzHourlyCustomizationModal = ({
  isOpen,
  toggle,
  selectedColumns,
  setSelectedColumns,
  ...
  availableColumns = ADZ_HOURLY_AVAILABLE_COLUMNS,
}) => {
  ...
  const handleReset = () => {
    setLocalColumns(normalizeSelection({
    ...
    <div className="ccm-overlay">
      <div className="ccm-modal">
        ...
        <div className="ccm-footer">
          <button type="button" className="ccm-cancel-btn" onClick={handleReset}>
            Reset to defaults
          </button>
          <div>
...
export default AdzHourlyCustomizationModal;