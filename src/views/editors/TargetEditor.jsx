...
const TargetEditor = (props) => {
  ...
  useEffect(() => {
    const geo = props.target?.geo;
  
    if (geo && geo.length !== 0 && geo[0] !== 0) {
      setGeo(geo);
      setZoom(8);
  ...
  const domainType = () => {
    if (!target) return null; // or some fallback
                           ...
                           type="text"
                            ...
                            <Col className="px-md-1" md="4">
                              <FormGroup>
                                ...
                                <Input type="text" id="domain" defaultValue={fromCommaList(target?.list_of_domains || "")}/>   
                              </FormGroup>
                            </Col>
