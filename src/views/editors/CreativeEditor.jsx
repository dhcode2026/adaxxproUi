...
const [siteorapp, setSiteorapp] = useState(props.creative.siteorapp);
 ...
 const [attributesselected, attributesetSelected] = useState([]);
...
const getSelectedRules = () => {
  return vx.rules.map((x) => {
    const isSelected = creative.rules.includes(x.id);
    return (
      <option key={`rules-${x.id}`} selected={isSelected} value={x.id}>
        {x.name}
      </option>
    );
  });
  ...
  const getCategoryList = () => {
    const checks = creative?.categories || [];
    const items = [];
    ...
    for (let i = 1; i <= 25; i++) {
      ...
      items.push({
        label: iab,
        value: iab,
        // Optionally: you can set a selected flag manually if needed
        // isSelected: checks.includes(iab)
      });
    }
...
<MultiSelect
  ...
  value={creativeselected}
  onChange={creativesetSelected}
  labelledBy="Select"
/>
                            ...
                            <Col className="pr-md-1" md="3">
                                <FormGroup>
                                    ...
                                    <Input type="select" id="attributes" >
                                        {getAttrList()}
                                    </Input>     
                              ...
                              <Label>Rules</Label>
                                <Input type="select" name="select" id="rules" multiple>
                                    {getSelectedRules()}
                                     ...
                                     {/* <MultiSelect
                                      options={getSelectedRules()}
                                      value={rulesselected}
                                      onChange={rulessetSelected}
                                      labelledBy="Select"
                                       id="rules"
                                        /> */}
                              </FormGroup>
                            ...
                            <Col className="pr-md-1" md="2">
                              ...
                              <FormGroup>
                                { appnexusSSP && <>
                                   ...
                                   <Label>CAssigned Creative ID:</Label>
                                   <Input
                                    id="appnexus_crid"
